...
export default function Home() {
  ...
  return (
    <>
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 bg-purple-600/60 backdrop-blur-sm z-50 border-b border-purple-200">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center">
            <Link href="/" className="flex items-center gap-1">
              <span className="text-white text-2xl font-bold">M</span>
              <span className="text-purple-200 text-2xl font-bold">Better</span>
      ...
      {/* Main Content - 添加 mt-20 来为固定的页眉留出空间 */}
      <div className="text-center min-h-screen flex flex-col justify-center items-center p-4 space-y-16 mt-20">
        {/* Hero Section */}
        <section className="max-w-6xl w-full">
          ...
          <Link href="/mbti-test" className="bg-purple-600 text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-purple-700 transition-colors duration-300">
            Start Your Journey
          </Link>
      ...
      <footer className="bg-white/80 backdrop-blur-sm border-t border-purple-100 py-8">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <Link href="/" className="flex items-center gap-1 mb-4">
                <span className="bg-gradient-to-r from-purple-800 to-purple-900 text-transparent bg-clip-text text-xl font-bold">M</span>
                <span className="text-purple-300 text-xl font-bold">Better</span>
                <span className="bg-gradient-to-r from-purple-800 to-purple-900 text-transparent bg-clip-text text-xl font-bold">TI</span>
              </Link>
              <p className="text-purple-600 text-sm">
            ...
            <div>
              <h4 className="font-semibold text-purple-800 mb-4">Features</h4>
              <ul className="space-y-2 text-purple-600 text-sm">
                <li><Link href="/ai-life-coach">AI Life Coach</Link></li>
                <li><Link href="/growth-records">Growth Records</Link></li>
                <li><Link href="/challenges">Challenges</Link></li>
              </ul>
            </div>
            
            <div>
              <h4 className="font-semibold text-purple-800 mb-4">Resources</h4>
              <ul className="space-y-2 text-purple-600 text-sm">
                <li><Link href="/mbti-test">MBTI Test</Link></li>
            ...
            <div>
              <h4 className="font-semibold text-purple-800 mb-4">Contact</h4>
              <ul className="space-y-2 text-purple-600 text-sm">
                <li>support@mbetterti.com</li>
          ...
          <div className="mt-8 pt-8 border-t border-purple-100 text-center text-sm text-purple-600">
            <p>© 2024 MBetterTI. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
