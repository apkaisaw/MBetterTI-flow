      ...
      >
        {mockNFTs.map((nft) => (
          ...
          >
            ...
            <p className="text-purple-600 mb-4">{t('creator')}: {nft.creator}</p>
        ...
        {showCreateModal && (
          ...
          >
            ...
            >
              ...
              <h2 className="text-2xl font-semibold mb-6 text-purple-800">{t('createNewNFT')}</h2>
              <form>
                <div className="mb-6">
        ...
        {selectedNFT && (
          ...
          >
            ...
            >
              ...
              <p className="text-purple-600 mb-4">{t('creator')}: {selectedNFT.creator}</p>
