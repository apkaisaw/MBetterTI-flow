...
learning to let go of your passion and intensity for a respite.`,
  ...
  },
  {
    ...
    description: `As an INFP, your primary mode of living is focused internally, dealing with things based on your personal values and feelings. Your secondary mode is external, taking in information via intuition.

INFP's are idealistic perfectionists driven to make the world better for people. They constantly seek meaning in life and their purpose in serving humanity. They rely heavily on intuition and filter everything through their value system to refine their life path.

INFP's are thoughtful listeners who genuinely care about understanding others. Though reserved in expressing emotion, they have deep caring and make valued friends and confidantes. They avoid conflict but can become passionate defenders when their values are threatened.

When committed to a cause, INFP's will pursue it with determination. They excel at big picture thinking but may overlook everyday details. They prefer dealing with feelings and human elements over hard logic and facts.

INFP's set very high standards for themselves and can be overly self-critical. They may struggle in group work due to their perfectionism. Many INFP's have strong writing abilities and do well in helping professions like counseling or teaching.

At their best, INFP's can be great humanistic catalysts, though they rarely give themselves credit. They need to balance their ideals with practical reality to find fulfillment.`,
    jungianFunctionalPreference: {
